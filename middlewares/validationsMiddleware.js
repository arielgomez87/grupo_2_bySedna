...
const validations = [ /*este array contiene a los check del registro*/
    check('fullName').isLength({min:2}).withMessage('Debe ingresar un nombre'),
    check('address').isLength({min:2}).withMessage('Debe ingresar un direccion'),
    ...
    check('password').isLength({min:8}).withMessage('Debe ingresar una contraseña de mas de 8 caracteres'),
]
